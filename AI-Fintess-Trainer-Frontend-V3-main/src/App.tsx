      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/bmi-calculator"
              element={session ? <BmiCalculator /> : <Navigate to="/auth" />}
            />

            <Route
              path="/suggested-workouts"
              element={session ? <SuggestedWorkouts /> : <Navigate to="/auth" />}
            />

            <Route
              path="/perform-exercise"
              element={session ? <PerformExercise /> : <Navigate to="/auth" />}
            />

            <Route
              path="/exercise-history"
              element={session ? <ExerciseHistory /> : <Navigate to="/auth" />}
            />

            <Route
              path="/exercise-tutorials"
              element={session ? <ExerciseTutorials /> : <Navigate to="/auth" />}
            />

            <Route
              path="/ai-chatbot"
              element={session ? <AIChatbot /> : <Navigate to="/auth" />}
            />
